...
{
  gsl_multiset *m;
  TypedData_Get_Struct(mm, gsl_multiset, &gsl_multiset_data_type, m);
...
VALUE rb_gsl_multiset_memcpy(VALUE klass, VALUE m1, VALUE m2)
{
  ...
  TypedData_Get_Struct(m1, gsl_multiset, &gsl_multiset_data_type, mm1);
  TypedData_Get_Struct(m2, gsl_multiset, &gsl_multiset_data_type, mm2);
